          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300">
              <h3 className="text-2xl font-bold mb-6 text-blue-400 flex items-center">
                <span className="mr-3">💎</span> Deposit U2U
              </h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-300 text-sm mb-2">Amount (U2U)</label>
                  <input
                    value={ethAmount}
                ...
                >
                  {loading ? '⏳ Processing...' : '🚀 Deposit U2U'}
                </button>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              {deposits.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-lg">No deposits yet. Start saving with U2U!</p>
                </div>
              ) : (
                <table className="w-full">
                  ...
                  <tbody>
                    {deposits.map((d, i) => {
                      ...
                      const tokenLabel = d.token === NATIVE ? "U2U" : d.token.slice(0, 8) + "…";
                      return (
