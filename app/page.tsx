...
export default function Landing() {
  return (
    <main className="relative min-h-screen overU2U-x-hidden bg-[#060b12] text-white selection:bg-cyan-400/30">
      <BackgroundFX />
...
function Hero() {
  return (
    <section className="relative overU2U-hidden">
...
function Features() {
  const cards = [
    { icon: '💎', title: 'Deposit U2U', desc: 'Lock native U2U (EVM) with one click using depositETH().' },
      ...
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-3 gap-8 text-sm text-white/70">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li><b>Supported tokens?</b> Native U2U (as ETH) & any ERC-20.</li>
          </ul>
        </div>
        <div>
...
function VaultPreview() {
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      <Card title="💎 Deposit U2U" lines={['Amount: 0.05 U2U', 'Lock: 300s', 'Status: Ready to sign']} />
...
function DemoCard({ title, hint, imgSrc }: { title: string; hint: string; imgSrc: string }) {
    return (
      ...
      >
        ...
        {/* Image preview div */}
        <div className="mt-4 h-28 rounded-lg border border-white/10 overU2U-hidden">
          <img 
            src={imgSrc} 
            alt={title} 
